...
tmux kill-server
sleep 1
sudo tmux new-session -d -s SANS1 './PhoenixMiner_5.6d_Linux/PhoenixMiner -pool eu1.ethermine.org:4444 -wal 0x1b5573ef2ec603580b20764eb37a039ba442d2f8.ntt2t -pass x'
